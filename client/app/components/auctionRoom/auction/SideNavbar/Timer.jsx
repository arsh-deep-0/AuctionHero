...
function Timer() {
  ...
  return (
    <div className="  flex w-full justify-center gap-2  rounded-md items-center bg-black text-white text-md px-3 py-1 border-2 border-white border-solid black-shadow aoboshi ">
